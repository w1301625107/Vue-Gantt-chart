...
describe('测试timeLineUtils.js', function() {
  describe('测试calcScalesAbout2Times函数', function() {
    it('相同时间 计算结果为1', function() {
      expect(func.calcScalesAbout2Times(moment(
  ...
  describe('测试getBeginTimeOfTimeLine函数', function() {
    it('测试数据1', function() {
      expect( func.getBeginTimeOfTimeLine(moment('2018-10-11 00:00:00')).toString())
        .to.be.equal(moment('2018-10-11 00:00:00').toString());
    });

    it('测试数据2', function() {
      expect( func.getBeginTimeOfTimeLine(moment('2018-10-11 00:00:00'),3).toString())
        .to.be.equal(moment('2018-10-11 00:00:00').toString());
    });

    it('测试数据3', function() {
      expect( func.getBeginTimeOfTimeLine(moment('2018-10-11 00:04:00'),3).toString())
        .to.be.equal(moment('2018-10-11 00:03:00').toString());
    });

    it('测试数据4', function() {
      expect( func.getBeginTimeOfTimeLine(moment('2018-10-11 01:11:00'),10).toString())
